...
public class ExpressionApiModelTest
{
    ...
    // {
    //     Assert.Equal("expression.primitive", new PrimitiveExpressionApiModel(new Mock<PrimitiveExpressionApiModel>().Object).Type);
    // }
    ...
    {
        var classNameExpression =new Mock<PrimitiveExpressionApiModel>().Object;
    ...
    {
        var methodNameExpression = new Mock<PrimitiveExpressionApiModel>().Object;
